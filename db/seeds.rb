...
User.create(username: "Iggy", image: "https://i.ibb.co/WkjPbg3/iggy.jpg", emoji_id: rand(1..8), drink_id: rand(1..6))
...
User.create(username: "Robert", image: "https://i.ibb.co/XYKz572/robert.png", emoji_id: rand(1..8), drink_id: rand(1..6))
User.create(username: "Tashi", image: "https://i.ibb.co/RHgcF3z/tashi.png", emoji_id: rand(1..8), drink_id: rand(1..6))
User.create(username: "O", image: "https://i.ibb.co/bQ7Lrqv/link2.png", emoji_id: rand(1..8), drink_id: rand(1..6))
